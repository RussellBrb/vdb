...
## [2026-06-03] Codex: repo tidy completed without engine change
Moved governance, reference, and planning docs under `/docs` using `git mv`; kept `vdb.js` at root for CDN. Updated live cross-references, verified harness green and CDN `@v14` still HTTP 200. No tag bump.
