...
**Live:** `https://cdn.jsdelivr.net/gh/RussellBrb/vdb@v11.1/vdb.js`

```html
<div id="v"></div>
<script src="https://cdn.jsdelivr.net/gh/RussellBrb/vdb@v11.1/vdb.js"></script>
<script>
VDB('#v', {
...
| `v11.1` | `flow` label stagger (no overlap) · inline `**markdown**` in `note`/`callout` |
